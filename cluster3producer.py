...
consumer = KafkaConsumer(
    'forward_to_cluster3_topic', 
    bootstrap_servers='localhost:9092', 
    group_id='cluster3_group'
)
...
def forward_to_subscribers(message):
    ...
    producer.send('cluster3_subscriber1_topic', value=value.encode('utf-8'))
    producer.send('cluster3_subscriber2_topic', value=value.encode('utf-8'))
    producer.send('cluster3_subscriber3_topic', value=value.encode('utf-8'))
